...
def display_instances(image, boxes, masks, class_ids, class_names,
    ...
    print("We are now in the dispay_instances function.")
    """
    ...
    auto_show = False
    if not ax:
        _, ax = plt.subplots(1, figsize=figsize, frameon=False,)
        auto_show = True
    ...
    if auto_show:
        ...
        if os.path.exists(NEW_IMAGE_NAME):
            NEW_IMAGE_NAME += '_1'
        NEW_IMAGE_PATH = os.path.join(UPLOAD_FOLDER_PATH, NEW_IMAGE_NAME)
