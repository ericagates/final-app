...
def initializeModel():
    ...
    # IMPORTANT TO GET RIDE OF THE BUG
...
def myFunction(filename):
    ...
    #looks like model.detect line 2482 uses mold_inputs onl ine 2503
    #to adjust the image size automatically (see line 2378)
